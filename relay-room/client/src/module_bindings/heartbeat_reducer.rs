...
impl From<HeartbeatArgs> for super::Reducer {
    fn from(args: HeartbeatArgs) -> Self {
        Self::Heartbeat { agent: args.agent }
    }
}
...
pub trait heartbeat {
    ...
    fn heartbeat(&self, agent: String) -> __sdk::Result<()> {
        self.heartbeat_then(agent, |_, _| {})
    }
...
impl heartbeat for super::RemoteReducers {
    fn heartbeat_then(
        ...
        self.imp
            .invoke_reducer_with_callback(HeartbeatArgs { agent }, callback)
    }
}
