...
class TestServicePreflight(unittest.TestCase):
    ...
    def test_check_litellm_structure(self):
        from justai.health import check_litellm, ServiceStatus
    ...
    def test_check_spacetimedb_structure(self):
        from justai.health import check_spacetimedb, ServiceStatus
        result = check_spacetimedb()
        self.assertIsInstance(result, ServiceStatus)
        self.assertEqual(result.name, "SpacetimeDB")

    def test_check_memory_structure(self):
        from justai.health import check_memory, ServiceStatus
        result = check_memory()
        self.assertIsInstance(result, ServiceStatus)
    ...
    def test_print_preflight_returns_bool(self):
        from justai.health import print_preflight, ServiceStatus
        statuses = [
